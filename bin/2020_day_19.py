...
if __name__ == '__main__':
    ...
    regex = go_deep(0, 0)
    print('Answer part 1 = {:d} '.format(sum([bool(re.fullmatch(regex, i)) for i in dataset[1].split('\n')])), 216)
    rules[8] = '42 | 42 8'
    rules[11] = '42 31 | 42 11 31'
    regex = go_deep(0, 0)
    print('Answer part 2 = {:d} '.format(sum([bool(re.fullmatch(regex, i)) for i in dataset[1].split('\n')])), 400)
